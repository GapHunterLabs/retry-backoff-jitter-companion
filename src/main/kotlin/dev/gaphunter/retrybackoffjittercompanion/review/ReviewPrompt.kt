package dev.gaphunter.retrybackoffjittercompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.retrybackoffjittercompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.retrybackoffjittercompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Retry Without Backoff+Jitter Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34008-retry-without-backoff-jitter-companion/reviews"
